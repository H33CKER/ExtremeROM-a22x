...
# Settings
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=ZCASMA226BN,1_ZCASMA226BN1
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_DEFAULT_FONT_SIZE=3
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A22 5G

# SSRM
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a22x_mt6833
